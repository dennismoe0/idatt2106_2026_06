...
const routes = [
  ...
  { path: '/join',         name: 'Join',         component: () => import('@/views/student/JoinClassroomView.vue'), meta: { public: true } },
  { path: '/waiting',      name: 'Waiting',      component: () => import('@/views/student/WaitingRoomView.vue'), meta: { public: true } },
