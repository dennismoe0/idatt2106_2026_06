...
const MOCK_TASKS = [
  {
    ...
    contentJson: {
      articles: [
        { headline: 'Trondheim kommune deler ut gratis nettbrett til alle elever', body: 'Kommunen tester ny digital satsing i fire bydeler.', source: 'Adresseavisen' },
        { headline: 'Forskere fant usynlig energi i skolemelk', body: 'Artikkelen påstår at melk gir superkrefter etter klokken 19.', source: 'nyheter24-ekte.no' }
      ]
    },
    mockCorrectAnswer: { article_0: true, article_1: false },
    mockExplanation: 'Den andre artikkelen bruker en useriøs kilde og usannsynlige påstander.'
  },
  {
    id: 1002,
    stopId: 1,
...
async function loadTasks() {
  ...
  try {
    ...
    if (import.meta.env.DEV) {
      tasks.value = MOCK_TASKS.filter(t => t.stopId === stopId.value)
